...
public class GameCharacterAdaptater extends ArrayAdapter<com.example.planyourmurder.ui.model.GameCharacter> {
    private final Context _context;
    private LinkedList<com.example.planyourmurder.ui.model.GameCharacter> _chars;

    public GameCharacterAdaptater(Context context, int resource, LinkedList<com.example.planyourmurder.ui.model.GameCharacter> chars){
