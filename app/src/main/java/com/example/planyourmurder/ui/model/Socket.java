...
import com.example.planyourmurder.BuildConfig;
import com.example.planyourmurder.ui.controller.MainActivity;
...
public class Socket {
    ...
    private final WebSocketListener webSocketListener = new WebSocketListener() {
        ...
        public void onMessage(WebSocket webSocket, String text) {
            ...
            try {
                ...
                if (eventListener.get(type) != null) {
                    eventListener.get(type).onMessage(Socket.this, type);
                }
         ...
         * - First GET request had been failed => response null, Throwable {@link IOException}
         * - Fail to send Ping => response null, Throwable {@link IOException}
         * - Fail to send data frame => response null, Throwable {@link IOException}
         * - Fail to read data frame => response null, Throwable {@link IOException}
         */
        @Override
